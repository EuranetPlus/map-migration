export const config = {
	mapTitle: 'migration-europe', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-migration.vercel.app', // The url provided when deploying the map on Vercel
